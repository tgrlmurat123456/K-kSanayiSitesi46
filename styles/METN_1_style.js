...
var style_METN_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelFont = "13.0px \'Wide Latin\', sans-serif";
    var labelFill = "#5cfff2";
    var bufferColor = "";
    var bufferWidth = 0;
    var textAlign = "left";
    var offsetX = 0;
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("METİN") !== null) {
        labelText = String(feature.get("METİN"));
    }
